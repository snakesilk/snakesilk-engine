...
describe('Entity', () => {
  ...
  describe('on instantiation', () => {
    ...
    describe('#moveTo', () => {
      describe('when setting x, y, z components', () => {
        beforeEach(() => {
          entity.moveTo({
            x: 123.2,
            y: 54.2,
        ...
        describe('when using subset of components', () => {
          beforeEach(() => {
            entity.moveTo({
              y: -354.2,
            });
        ...
        describe('when value is illegal', () => {
          beforeEach(() => {
            entity.moveTo({
              x: undefined,
              y: NaN,
